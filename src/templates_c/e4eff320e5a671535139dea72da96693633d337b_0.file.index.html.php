<?php
/* Smarty version 3.1.34-dev-7, created on 2023-11-23 14:05:57
  from 'C:\select_lesson\templates\index.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array(
    'version' => '3.1.34-dev-7',
    'unifunc' => 'content_655f5c451cfd46_02075286',
    'has_nocache_code' => false,
    'file_dependency' =>
        array(
            'e4eff320e5a671535139dea72da96693633d337b' =>
                array(
                    0 => 'C:\\select_lesson\\templates\\index.html',
                    1 => 1700748356,
                    2 => 'file',
                ),
        ),
    ...
    function content_655f5c451cfd46_02075286(Smarty_Internal_Template $_smarty_tpl)
    {
        ?>
        <html>
    ...
    <div class='container'>
        <div class="col-md-16" id="shop_head">
            ...
            <a class="home-link" href="index.php?op=search">
                <img alt="home" src="templates/web_image/home/home.png" width="80">
            ...
            <div class="row" id="shop_main">
                <div class="col-md-9 col-sm-8" id="show_shop">
                    ...
                    <?php } elseif ($_smarty_tpl->tpl_vars['op']->value == "addclass" && $_smarty_tpl->tpl_vars['isuser']->value != false) { ?>
                        ...
                        ?>
                    <?php } elseif ($_smarty_tpl->tpl_vars['op']->value == "search_result" || $_smarty_tpl->tpl_vars['op']->value == "chose_class" && $_smarty_tpl->tpl_vars['isuser']->value != false) { ?>
                    ...
                    <?php } elseif ($_smarty_tpl->tpl_vars['op']->value == "lessonCancel" && $_smarty_tpl->tpl_vars['isuser']->value != false) { ?>
                        ...
                        ?>
                    <?php } elseif ($_smarty_tpl->tpl_vars['op']->value == "search" && $_smarty_tpl->tpl_vars['isuser']->value != false) { ?>
