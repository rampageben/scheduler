	...
	bender.test({
		...
		'test style.parse.margin docs sample': function () {
			assertObject({
				...
				bottom: '2',
				left: '0'
			}, CKEDITOR.tools.style.parse.margin('3px 0 2'));
		},
		...
		'test style.parse.sideShorthand docs sample': function () {
			assertObject({
				...
				bottom: 'solid',
				left: 'dotted'
			}, CKEDITOR.tools.style.parse.sideShorthand('solid dotted'));
		},
		...
		'test style.parse.sideShorthand 1 member': function () {
			assertObject({
				...
				bottom: '1px',
				left: '1px'
			}, CKEDITOR.tools.style.parse.sideShorthand('1px'));
		},
		...
		'test style.parse.sideShorthand 2 members': function () {
			assertObject({
				...
				bottom: '1px',
				left: '2px'
			}, CKEDITOR.tools.style.parse.sideShorthand('1px 2px'));
		},
		...
		'test style.parse.sideShorthand 3 members': function () {
			assertObject({
				...
				bottom: '3px',
				left: '2px'
			}, CKEDITOR.tools.style.parse.sideShorthand('1px 2px 3px'));
		},
		...
		'test style.parse.sideShorthand 4 members': function () {
			assertObject({
				...
				bottom: '3px',
				left: '4px'
			}, CKEDITOR.tools.style.parse.sideShorthand('1px 2px 3px 4px'));
		},
		...
		'test style.border color normalization': function () {
			assertObject({
				...
				width: null,
				style: null
			}, new CKEDITOR.tools.style.border({color: 'windowtext'}));
		},

		// (#1490)
		'test style.border.toString is overwriten': function () {
			assert.areEqual('1px solid red', new CKEDITOR.tools.style.border({
				color: 'red',
				width: '1px',
				style: 'solid'
			}));
		...
		'test style.border.fromCssRule docs sample': function () {
			assertObject({
				...
				style: 'solid',
				color: '#ffeedd'
			}, CKEDITOR.tools.style.border.fromCssRule('3px solid #ffeedd'));
		},
		...
		'test style.border.fromCssRule with width and style': function () {
			assertObject({
				...
				style: 'groove',
				color: null
			}, CKEDITOR.tools.style.border.fromCssRule('0% groove'));
		},
		...
		'test style.border.fromCssRule with mixed color and style': function () {
			assertObject({
				...
				style: 'dotted',
				width: null
			}, CKEDITOR.tools.style.border.fromCssRule('#ff0000 dotted'));
		},
		...
		'test style.border.fromCssRule with mixed color, style and width': function () {
			assertObject({
				...
				color: '#ff0000',
				style: 'dotted'
			}, CKEDITOR.tools.style.border.fromCssRule('#ff0000 dotted 7.5em'));
		},
		...
		'test style.border.fromCssRule with style only': function () {
			assertObject({
				...
				style: 'dotted',
				color: null
			}, CKEDITOR.tools.style.border.fromCssRule('dotted'));
		},
		...
		'test style.border.fromCssRule with style and rgba color': function () {
			assertObject({
				...
				style: 'dotted',
				color: 'rgba(0,0,0,0)'
			}, CKEDITOR.tools.style.border.fromCssRule('dotted rgba(0,0,0,0)'));
		},
		...
		'test style.border.fromCssRule with style and hsla color': function () {
			assertObject({
				style: 'dotted',
				color: 'hsla(10,30%,30%,1)'
			}, CKEDITOR.tools.style.border.fromCssRule('dotted hsla(10,30%,30%,1)'));
		},
