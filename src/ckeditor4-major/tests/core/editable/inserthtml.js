			...
			a('foo<span><b>bar[</b></span>baz]',
				{
					...
					text: 'foo<span><b>barbam^</b></span>'
				}, 'after nested 1');
			a('foo<span><b>bar</b>[</span>baz]',
				{
					html: 'foo<span><b>bar</b></span>bam^',
					text: 'foo<span><b>bar</b>bam^</span>'
				}, 'after nested 2');
		},
			...
			a('foo<u title="a">x^z</u>baz',
				{
					...
					text: 'foo<u title="a">xbam^z</u>baz'
				}, 'copy attributes');

			a('<p>a<b>c^d</b>e</p>',
				{
					html: '<p>a<b>c</b>bam^<b>d</b>e</p>',
					text: '<p>a<b>cbam^d</b>e</p>'
				}, 'preserve block');
		},
