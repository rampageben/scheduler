...
//		},
		...
		'test eventsBuffer': function () {
			assert.isTrue(CKEDITOR.tools.eventsBuffer(200, function () {
			}) instanceof CKEDITOR.tools.buffers.event);
		},
		...
		'test throttle': function () {
			assert.isTrue(CKEDITOR.tools.throttle(200, function () {
			}) instanceof CKEDITOR.tools.buffers.throttle);
		},
