...
(function () {
	...
	t = createAssertionFunction2(tcs, 'test apply inline style - override single element style', {
		element: 'b',
		overrides: 'i'
	});
	...
	t = createAssertionFunction2(tcs, 'test remove inline style - override single element style', {
		element: 'b',
		overrides: 'i'
	});
	...
	t = createAssertionFunction2(tcs, 'test apply inline styles on non-editable inline elements - includeReadonly', {
		element: 'b',
	...
	t = createAssertionFunction2(tcs, 'test remove inline styles from non-editable inline elements - includeReadonly', {
		element: 'b',
		includeReadonly: true
	});
	...
	t = createAssertionFunction2(tcs, 'test apply inline styles on non-editable block elements - includeReadonly', {
		element: 'b',
		includeReadonly: true
	});
	applyInlineToNonEditableBlocks(t);
	...
	t = createAssertionFunction2(tcs, 'test remove inline styles from non-editable block elements - includeReadonly', {
		element: 'b',
		includeReadonly: true
	});
	removeInlineFromNonEditableBlocks(t);
	...
	t = createAssertionFunction2(tcs, 'test apply inline styles on nested editables - includeReadonly', {
		element: 'b',
		includeReadonly: true
	});
	...
	t = createAssertionFunction2(tcs, 'test remove inline styles from nested editables - includeReadonly', {
		element: 'b',
		includeReadonly: true
	});
	removeInlineFromNestedEditables(t);
	...
	(function () {
		t = createAssertionFunction2(tcs, 'test apply inline styles on nested editables - ACF integration', {
			element: 'b',
			includeReadonly: true
		});
	...
	t = createAssertionFunction2(tcs, 'test apply style with data- attribute', {
		element: 'span',
		attributes: {'data-element': 'a', lang: 'en'}
	});
	...
	t = createAssertionFunction2(tcs, 'test remove style with data- attribute', {
		element: 'span',
		attributes: {'data-element': 'a'}
	});
