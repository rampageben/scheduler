...
(function () {
	...
	addTestCases(tcs, {
		...
		getRangeInText: {
			'two text nodes - range at first': ['<p>foo.bar</p>', {
				sc: '#foo',
				so: 2,
				ec: '#foo',
				eo: 2
			}, 1, 3, 'foo', {sc: '#foo', so: 1, ec: '#foo', eo: 3}],
			'two text nodes - range at second': ['<p>foo.bar</p>', {
				sc: '#foo',
				so: 0,
				ec: '#foo',
				eo: 0
			}, 3, 5, 'foo.bar', {sc: '#foo', so: 3, ec: '#bar', eo: 2}],
			'two text nodes - range at both': ['<p>foo.bar</p>', {
				sc: '#foo',
				so: 2,
				ec: '#foo',
				eo: 2
			}, 1, 5, 'foo.bar', {sc: '#foo', so: 1, ec: '#bar', eo: 2}],
			'begin to middle': ['<p>Hello</p>', {
				sc: '#Hello',
				so: 0,
				ec: '#Hello',
				eo: 0
			}, 0, 1, '<p>Hello</p>', {sc: '#Hello', so: 0, ec: '#Hello', eo: 1}],
			'middle to middle': ['<p>Hello</p>', {
				sc: '#Hello',
				so: 0,
				ec: '#Hello',
				eo: 0
			}, 2, 3, '<p>Hello</p>', {sc: '#Hello', so: 2, ec: '#Hello', eo: 3}],
			'middle to end': ['<p>Hello</p>', {
				sc: '#Hello',
				so: 0,
				ec: '#Hello',
				eo: 0
			}, 3, 5, '<p>Hello</p>', {sc: '#Hello', so: 3, ec: '#Hello', eo: 5}],
			'begin to end': ['<p>Hello</p>', {
				sc: '#Hello',
				so: 0,
				ec: '#Hello',
				eo: 0
			}, 0, 5, '<p>Hello</p>', {sc: '#Hello', so: 0, ec: '#Hello', eo: 5}]
