...
(function () {
	...
	var tests = {
		...
		'test split cells': function (editor, bot) {
			...
			doCommandTest(bot, 'cellHorizontalSplit', {
				'case': 'split-cells-2',
				cells: [3],
				skipCheckingSelection: true
			});
			doCommandTest(bot, 'cellHorizontalSplit', {
				'case': 'split-cells-3',
				cells: [2],
		...
		'test delete nested cells': function (editor, bot) {
			doCommandTest(bot, 'cellDelete', {
				'case': 'delete-nested-cells',
				cells: [1, 2],
				skipCheckingSelection: true
			});
			doCommandTest(bot, 'cellDelete', {
				'case': 'delete-nested-cells-2',
				cells: [2, 3],
				skipCheckingSelection: true
			});
			doCommandTest(bot, 'cellDelete', {
				'case': 'delete-nested-cells-3',
				cells: [1, 2, 3, 4],
				skipCheckingSelection: true
			});
		},
		...
		'test remove row from middle row': function (editor, bot) {
			doCommandTest(bot, 'rowDelete', {
				'case': 'delete-row-from-middle',
				cells: [1],
				skipCheckingSelection: true
			});
		},
		...
		'test remove trailing column': function (editor, bot) {
			doCommandTest(bot, 'columnDelete', {
				'case': 'delete-column-trailing',
				cells: [3],
				skipCheckingSelection: true
			});
		},
