...
(function () {
	...
	tests['internal paste is not filtered'] = function () {
		...
		assertPasteEvent(editor, {
				...
				dataTransfer: mockDataTransfer(CKEDITOR.DATA_TRANSFER_INTERNAL)
			},
			{dataValue: '<h2>Foo <strong>bar</strong></h2>'});
	};
	...
	tests['cross-editors paste is not filtered'] = function () {
		...
		assertPasteEvent(editor, {
				dataValue: '<h2>Foo <strong>bar</strong></h2>',
				dataTransfer: mockDataTransfer(CKEDITOR.DATA_TRANSFER_CROSS_EDITORS)
			},
			{dataValue: '<h2>Foo <strong>bar</strong></h2>'});
	};
	...
	tests['external paste is filtered'] = function () {
		...
		assertPasteEvent(editor, {
				dataValue: '<h2>Foo <strong>bar</strong></h2>',
				dataTransfer: mockDataTransfer(CKEDITOR.DATA_TRANSFER_EXTERNAL)
			},
			{dataValue: '<p>Foo bar</p>'});
	};
