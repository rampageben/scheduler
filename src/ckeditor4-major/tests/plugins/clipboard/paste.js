	...
	bender.test({
		...
		'htmlified text unification': function () {
			...
			CKEDITOR.env.gecko && assertPasteEvent(
				...
				{
					type: 'text',
					dataValue: '<p>1aaa<br>2bbb&nbsp;&nbsp; &nbsp;ccc</p><p>&nbsp; 3ddd<br>&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;' +
			...
			CKEDITOR.env.ie && assertPasteEvent(
				...
				{
					type: 'text',
					dataValue: '<p>1aaa<br>2bbb&nbsp;ccc</p><p>&nbsp; 3ddd<br>&nbsp;&nbsp;4eee<br>&nbsp;5fff</p><p><br>6ggg&nbsp; hhh<br></p>'
				},
				'htmlified text - ie'
			);
			CKEDITOR.env.webkit && assertPasteEvent(
				...
				{
					type: 'text',
					dataValue: '<p>1aaa<br>2bbb&nbsp;&nbsp; &nbsp;ccc</p><p>&nbsp; 3ddd<br>&nbsp;&nbsp; &nbsp; 4eee<br> 5fff</p><p><br>6ggg &nbsp;hhh</p><br data-cke-eol="1">'
				},
				...
				function (editor) {
					if (CKEDITOR.env.gecko) {
						...
						assertPasteEvent(editor,
							...
							'htmlified text 3 - fx');
						assertPasteEvent(editor,
							{dataValue: '<br>aa<br><br>bb<br>cc<br>'}, {
								type: 'text',
								dataValue: '<br>aa<br><br>bb<br>cc<br>'
							},
							'htmlified text 4 - fx');
				...
				function (editor) {
					if (CKEDITOR.env.gecko) {
						assertPasteEvent(editor,
							...
							'htmlified text 1 - fx');
						assertPasteEvent(editor,
							{dataValue: 'aa<br>bb<br><br>cc'}, {
								type: 'text',
								dataValue: '<div>aa<br>bb</div><div>cc</div>'
							},
							'htmlified text 2 - fx');
					} else if (CKEDITOR.env.ie) {
						assertPasteEvent(editor,
		...
		'html textification <ul> <li>A1</li> <li>A2 <ol> <li>B1</li> <li>B2</li> </ol></li> </ul> <ol> <li>C1</li> </ol>': function () {
			assertPasteEvent(this.editor,
				{
					type: 'text',
					dataValue: '<ul> <li>A1</li> <li>A2 <ol> <li>B1</li> <li>B2</li> </ol></li> </ul> <ol> <li>C1</li> </ol>'
				},
		...
		'html textification <dl> <dt>AT</dt> <dd>AD <dl> <dt>BT</dt> <dd>BD1</dd><dd>BD2</dd> </dl></dd> </dl>': function () {
			...
			assertPasteEvent(this.editor,
				{
					type: 'text',
					dataValue: '<dl> <dt>AT</dt> <dd>AD <dl> <dt>BT</dt> <dd>BD1</dd><dd>BD2</dd> </dl></dd> </dl>'
				},
		...
		'html textification X<table> <caption>C</caption> <tr><th>A1</th><td>A2</td></tr> <tr><td>B1</td><th>B2</th></tr> </table>X': function () {
			...
			assertPasteEvent(this.editor,
				{
					type: 'text',
					dataValue: 'X<table> <caption>C</caption> <tr><th>A1</th><td>A2</td></tr> <tr><td>B1</td><th>B2</th></tr> </table>X'
				},
		...
		'html textification <table> <tr><td>A1</td> <td><table><tr><td>B1</td><td>B2</td></table></td></tr> <tr><td>C1</td></tr> </table>': function () {
			...
			assertPasteEvent(this.editor,
				{
					type: 'text',
					dataValue: '<table> <tr><td>A1</td> <td><table><tr><td>B1</td><td>B2</td></table></td></tr> <tr><td>C1</td></tr> </table>'
				},
		...
		'html textification 6 - tricks <p>A</p> <h1>T1</h1> <h2>T2</h2> <h3>T3</h3> <p>C</p> <h4>T4</h4> D <h5>T5</h5>': function () {
			assertPasteEvent(this.editor,
				{
					type: 'text',
					dataValue: '<p>A</p> <h1>T1</h1> <h2>T2</h2> <h3>T3</h3> <p>C</p> <h4>T4</h4> D <h5>T5</h5>'
				},
			...
			testEditor(this, {enterMode: CKEDITOR.ENTER_DIV},
				function (editor) {
					assertPasteEvent(editor,
						...
						{
							type: 'text',
							dataValue: '<div><div>AT</div><div>AD<div><div>BT</div><div>BD1</div><div>BD2</div></div></div></div>'
						},
						'def lists');
				});
		},
		...
		'fixing block content': function () {
			if (CKEDITOR.env.ie) {
				...
				assertPasteEvent(this.editor, {
						dataValue: '<br class="Apple-interchange-newline"><p>A<b>B</b>C</p>',
						type: 'text'
					},
				...
				assertPasteEvent(this.editor, {
						dataValue: '<p><br class="Apple-interchange-newline">A</p><p>B</p><p>C</p>',
						type: 'text'
					},
					{
						type: 'text',
						dataValue: '<br data-cke-eol="1"><p>A</p><p>B</p><p>C</p>'
					}, 'eol 4 - produced multiple blocks selected');
			} else {
				assert.isTrue(true);
			}
		},
		...
		'test cut': function () {
			...
			assert.isInnerHtmlMatching('<p>x^x@</p>', bender.tools.selection.getWithHtml(editor), {
		...
		'test copy': function () {
			...
			assert.isInnerHtmlMatching('<p>x[b<b>a</b>r]x@</p>', bender.tools.selection.getWithHtml(editor), {
				compareSelection: true,
				normalizeSelection: true
			}, 'Editor content');
			assert.areSame(pasteEventMock.$.clipboardData, CKEDITOR.plugins.clipboard.copyCutData.$, 'copyCutData should be initialized');
