			...
			<fieldset>
				...
				<table width="100%">
					<tr>
						...
						<td>
							<input type="text" name="ld[cmt][sl][1][start]" id="ld[cmt][sl][1][start]"
								   value="<?= $ld['cmt']['sl'][1]['start']; ?>"/>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<input type="text" name="ld[cmt][sl][1][style]" id="ld[cmt][sl][1][style]"
								   value="<?= $ld['cmt']['sl'][1]['style']; ?>"/>
						</td>
					</tr>
				</table>
			</fieldset>
			...
			<fieldset>
				...
				<table width="100%">
					<tr>
						...
						<td>
							<input type="text" name="ld[cmt][sl][2][start]" id="ld[cmt][sl][2][start]"
								   value="<?= $ld['cmt']['sl'][2]['start']; ?>"/>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<input type="text" name="ld[cmt][sl][2][style]" id="ld[cmt][sl][2][style]"
								   value="<?= $ld['cmt']['sl'][2]['style']; ?>"/>
						</td>
					</tr>
				</table>
			</fieldset>
			...
			<fieldset>
				...
				<table width="100%">
					<tr>
						...
						<td>
							<input type="text" name="ld[cmt][ml][1][start]" id="ld[cmt][ml][1][start]"
								   value="<?= $ld['cmt']['ml'][1]['start']; ?>"/>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<input type="text" name="ld[cmt][ml][1][end]" id="ld[cmt][ml][1][end]"
								   value="<?= $ld['cmt']['ml'][1]['end']; ?>"/>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<input type="text" name="ld[cmt][ml][1][style]" id="ld[cmt][ml][1][style]"
								   value="<?= $ld['cmt']['ml'][1]['style']; ?>"/>
						</td>
					</tr>
				</table>
			</fieldset>
			...
			<fieldset>
				...
				<table width="100%">
					<tr>
						...
						<td>
							<input type="text" name="ld[cmt][ml][2][start]" id="ld[cmt][ml][2][start]"
								   value="<?= $ld['cmt']['ml'][2]['start']; ?>"/>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<input type="text" name="ld[cmt][ml][2][end]" id="ld[cmt][ml][2][end]"
								   value="<?= $ld['cmt']['ml'][2]['end']; ?>"/>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<input type="text" name="ld[cmt][ml][2][style]" id="ld[cmt][ml][2][style]"
								   value="<?= $ld['cmt']['ml'][2]['style']; ?>"/>
						</td>
					</tr>
				</table>
			</fieldset>
			...
			<fieldset>
				...
				<table width="100%">
					<tr>
						...
						<td>
							<input type="text" name="ld[cmt][rxc][1][rx]" id="ld[cmt][rxc][1][rx]"
								   value="<?= $ld['cmt']['rxc'][1]['rx']; ?>"/>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<input type="text" name="ld[cmt][rxc][1][style]" id="ld[cmt][rxc][1][style]"
								   value="<?= $ld['cmt']['rxc'][1]['style']; ?>"/>
						</td>
					</tr>
				</table>
			</fieldset>
			...
			<fieldset>
				...
				<table width="100%">
					<tr>
						...
						<td>
							<input type="text" name="ld[str][qm][1][delim]" id="ld[str][qm][1][delim]"
								   value="<?= $ld['str']['qm'][1]['delim']; ?>"/>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<input type="text" name="ld[str][qm][1][style]" id="ld[str][qm][1][style]"
								   value="<?= $ld['str']['qm'][1]['style']; ?>"/>
						</td>
					</tr>
				</table>
			</fieldset>
			<fieldset>
				...
				<table width="100%">
					<tr>
						...
						<td>
							<input type="text" name="ld[str][qm][2][delim]" id="ld[str][qm][2][delim]"
								   value="<?= $ld['str']['qm'][2]['delim']; ?>"/>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<input type="text" name="ld[str][qm][2][style]" id="ld[str][qm][2][style]"
								   value="<?= $ld['str']['qm'][2]['style']; ?>"/>
						</td>
					</tr>
				</table>
			</fieldset>
			...
			<fieldset>
				...
				<table width="100%">
					<tr>
						...
						<td>
							<input type="text" name="ld[str][ec][char]" id="ld[str][ec][char]"
					...
					<tr>
						...
						<td>
							<input type="text" name="ld[str][ec][style]" id="ld[str][ec][style]"
								   value="<?= $ld['str']['ec']['style']; ?>"/>
						</td>
					</tr>
				</table>
			</fieldset>
			...
			<fieldset>
				...
				<table width="100%">
					<tr>
						...
						<td>
							<input type="text" name="ld[str][erx][1][rx]" id="ld[str][erx][1][rx]"
								   value="<?= $ld['str']['erx'][1]['rx']; ?>"/>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<input type="text" name="ld[str][erx][1][style]" id="ld[str][erx][1][style]"
								   value="<?= $ld['str']['erx'][1]['style']; ?>"/>
						</td>
					</tr>
				</table>
			</fieldset>
			...
			<fieldset>
				...
				<table width="100%">
					<tr>
						...
						<td>
							<input type="text" name="ld[str][erx][2][rx]" id="ld[str][erx][2][rx]"
								   value="<?= $ld['str']['erx'][2]['rx']; ?>"/>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<input type="text" name="ld[str][erx][2][style]" id="ld[str][erx][2][style]"
								   value="<?= $ld['str']['erx'][2]['style']; ?>"/>
						</td>
					</tr>
				</table>
			</fieldset>
				...
				<tr>
					...
					<td>
						<select name=ld[kw_case]" id="ld[kw_case]">
							<option value="GESHI_CAPS_NO_CHANGE"<?= $kw_case_sel['GESHI_CAPS_NO_CHANGE']; ?>>Don’t
								change the case of any keyword
							</option>
							<option value="GESHI_CAPS_UPPER"<?= $kw_case_sel['GESHI_CAPS_UPPER']; ?>>Convert the case of
								all keywords to upper case
							</option>
							<option value="GESHI_CAPS_LOWER"<?= $kw_case_sel['GESHI_CAPS_LOWER']; ?>>Convert the case of
		...
		<fieldset>
			...
			<table width="100%">
				<tr>
					...
					<td>
						<textarea name="ld[kw][1][list]" id="ld[kw][1][list]" rows="10"
								  cols="80"><?= $ld['kw'][1]['list']; ?></textarea>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<input type="text" name="ld[kw][1][style]" id="ld[kw][1][style]"
							   value="<?= $ld['kw'][1]['style']; ?>"/>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<input type="text" name="ld[kw][1][docs]" id="ld[kw][1][docs]"
							   value="<?= $ld['kw'][1]['docs']; ?>"/>
					</td>
				</tr>
			</table>
		...
		<fieldset>
			...
			<table width="100%">
				<tr>
					...
					<td>
						<textarea name="ld[sy][0][list]" id="ld[sy][0][list]" rows="10"
								  cols="80"><?= $ld['sy'][0]['list']; ?></textarea>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<input type="text" name="ld[sy][0][style]" id="ld[sy][0][style]"
							   value="<?= $ld['sy'][0]['style']; ?>"/>
					</td>
				</tr>
			</table>
